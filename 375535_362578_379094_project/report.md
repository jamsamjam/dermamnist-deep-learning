...
- init: initializes the network. It defines the different layers such as the number and the size of each one. The size depends on the different values of the hidden_layer.
